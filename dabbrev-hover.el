...
;; Time-stamp: <2004-07-07 12:11:13 deego>
...
\\begin{equation} or gentleman, and you have typed about half of it,
you see a possible completion hovering next to what you type. Press
TAB to complete the completion.  This is similar to Openoffice's
behavior. The key TAB continues to work normally otherwise.
...
;; TODO: M-/ should give the next completion ala dabbrev (Javier and
;; Sitaram). 
; TODO: setting of dabbrev-case-fold-search (Sitaram)
...
(defcustom dh-min-length-abbrev 3 
  "The typed word must be atleast this long before we tooltip-show a
completion.")

(defcustom dh-min-length-expansion 6 
  "Any shown completion should be at least this long.")
